 ...
 *
 * <valv> at <linuxmail dot org>, 20 December 2017
 */
...
public class BigNumTest {
  ...
  public void testConstructCompare() throws Exception {
    ...
    String bigNumSting = "99887766554433221100";
    String bigNumHexSting = "ffeeddccbbaa99887766554433221100";
    // BigNum class has several constructors:
    // BigNum(), BigNum(int), BigNum(int, byte), BigNum(long),
    // BigNum(long, byte), BigNum(String), BigNum(String, byte), BigNum(BigNum)
    ...
    BigNum testNumber3 = new BigNum(Long.MAX_VALUE);
    assertNotNull("Long constructor failed:", testNumber3);

    BigNum testNumber4 = new BigNum(Long.MAX_VALUE, hex);
    assertNotNull("Long/radix constructor failed:", testNumber4);

    BigNum testNumber5 = new BigNum(bigNumSting);
    assertNotNull("String constructor failed:", testNumber5);

    BigNum testNumber6 = new BigNum(bigNumHexSting, hex);
    assertNotNull("String/radix constructor failed:", testNumber6);

    BigNum testNumber7 = new BigNum(testNumber3);
    assertNotNull("Object constructor failed:", testNumber7);

    BigNum testNumber8 = new BigNum();
    assertNotNull("Default (null) constructor failed:", testNumber8);
    ...
    System.out.println("\n...:::Initial data (BigNum):::..."
      ...
      + "\nNumber3 (Long) = " + testNumber3
      + "\nNumber4 (Long/hex) = " + testNumber4
      + "\nNumber3 (String) = " + testNumber5
      + "\nNumber4 (String/hex) = " + testNumber6
      + "\nNumber7 (Object) = " + testNumber7 + " (Number3)"
      + "\nNumber8 (Default) = " + testNumber8);
  }
